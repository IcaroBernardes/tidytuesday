...
colonialism <- tibble(
  ...
  flag = c(197583,197378,197393,197534,
           ...
           197441,197439,197562,197559,
           
           197560,197430,197473,197568,197505,
           197489,197511,
  ...
  `Past status` = c("Colonizer", rep("Colonized",3),
                    "Colonizer", rep("Colonized",46),
                    "Colonizer", rep("Colonized",3),
                    "Colonizer", rep("Colonized",5)
                    
                    ),
  
  group = c(rep("Belgium and its victims",4),
            rep("UK and its victims",47),
            rep("Netherlands and its victims",4),
            rep("France and its victims",6)
            ),
...
title <- glue::glue(
  ...
  This table shows groups of colonial empires. Countries are arranged by the sum of their most frequent score in Civil Liberties and Political Rights
